...
static asn_TYPE_member_t asn_MBR_bdms_2[] = {
	{ ATF_POINTER, 0, 0,
...
static ber_tlv_tag_t asn_DEF_bdms_tags_2[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_bdms_specs_2 = {
	sizeof(struct ResourceDatapointsReply__bdms),
	offsetof(struct ResourceDatapointsReply__bdms, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_bdms_2 = {
	"bdms",
	"bdms",
	SEQUENCE_OF_free,
	SEQUENCE_OF_print,
	...
	asn_DEF_bdms_tags_2,
	sizeof(asn_DEF_bdms_tags_2)
		/sizeof(asn_DEF_bdms_tags_2[0]) - 1, /* 1 */
	asn_DEF_bdms_tags_2,	/* Same as above */
	sizeof(asn_DEF_bdms_tags_2)
		/sizeof(asn_DEF_bdms_tags_2[0]), /* 2 */
	0,	/* No PER visible constraints */
	asn_MBR_bdms_2,
	1,	/* Single element */
	&asn_SPC_bdms_specs_2	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ResourceDatapointsReply_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ResourceDatapointsReply, bdms),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_TYPE_tag2member_t asn_MAP_ResourceDatapointsReply_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* bdms at 186 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* lastEntry at 188 */
};
