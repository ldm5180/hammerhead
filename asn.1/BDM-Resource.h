...
#ifndef	_BDM_Resource_H_
#define	_BDM_Resource_H_
...
struct BDM_Datapoint;

/* BDM-Resource */
typedef struct BDM_Resource {
	PrintableString_t	 id;
	ResourceFlavor_t	 flavor;
	ResourceDataType_t	 datatype;
	struct BDM_Resource__datapoints {
		A_SEQUENCE_OF(struct BDM_Datapoint) list;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_BDM_Resource;
