...
static asn_TYPE_member_t asn_MBR_BDMNewHab_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct BDMNewHab, hab),
...
static asn_TYPE_tag2member_t asn_MAP_BDMNewHab_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* bdmId at 154 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* entrySeq at 155 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* hab at 157 */
};
