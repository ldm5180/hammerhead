...
static asn_SET_OF_specifics_t asn_SPC_syncResources_specs_3 = {
	sizeof(struct BDMSyncRecord__syncResources),
	offsetof(struct BDMSyncRecord__syncResources, _asn_ctx),
...
static asn_TYPE_tag2member_t asn_MAP_BDMSyncRecord_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* bdmID at 348 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* syncResources at 350 */
};
