...
./configure \
    ...
    GLIB20_LIBS=$PETALINUX/software/petalinux-dist/glib/lib/libglib-2.0.la \
    ...
    OPENSSL_LIBS="$PETALINUX/software/petalinux-dist/openssl/libcrypto.a $PETALINUX/software/petalinux-dist/openssl/libssl.a"
