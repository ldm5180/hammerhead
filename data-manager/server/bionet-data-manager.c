...
void usage(void) {
	...
	"                                                --bdm-config-file\n"
	" -h,--hab,--habs \"HAB-Type.Hab-ID\"              Subscribe to a HAB list. Overrides --bdm-config-file\n"
	...
	" -n,--node,--nodes \"HAB-Type.HAB-ID.Node-ID\"    Subscribe to a Node list. Overrides --bdm-config-file\n"
#if ENABLE_ION
	...
	"                                                Subscribe to Resource values. Overrides --bdm-config-file\n"
