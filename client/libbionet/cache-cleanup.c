...
void cache_cleanup_hab(bionet_hab_t *hab) {
    ...
    for (i = libbionet_hab_subscriptions; i != NULL; i = i->next) {
        libbionet_hab_subscription_t *hab_sub = i->data;
    ...
    for (i = libbionet_node_subscriptions; i != NULL; i = i->next ) {
    ...
    for (i = libbionet_datapoint_subscriptions; i != NULL; i = i->next) {
    ...
    for (i = libbionet_stream_subscriptions; i != NULL; i = i->next) {
