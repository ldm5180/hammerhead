...
int bionet_subscribe_node_list_by_habtype_habid_nodeid(const char *hab_type,  const char *hab_id, const char *node_id) {
    ...
    m.type = Bionet_Message_C2N_Subscribe_Node_List;
    m.body.c2n_subscribe_node_list.hab_type = (char *)hab_type;
    m.body.c2n_subscribe_node_list.hab_id = (char *)hab_id;
    m.body.c2n_subscribe_node_list.node_id = (char *)node_id;
