...
int main(int argc, char** argv)
{
    ...
    /* do some HAB setup */
    env_hab = bionet_hab_new(ENV_HAB_TYPE, env_id);
    if (NULL == env_hab)
    {
...
{
    fprintf(fout,
	    "env-hab' ENV hardware abstractor\n"
	    "\n"
	    "Usage: env-hab [--version] [-s dir] [-v] [-d] [-?] [-i id] [-t sec] [-u dev]\n"
