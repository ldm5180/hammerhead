...
char *bionet_value_as_str(bionet_value_t *value)
{
	...
	g_log(BIONET_LOG_DOMAIN, G_LOG_LEVEL_WARNING, 
	      "bionet_value_as_str(): NULL value passed in");
	errno = EINVAL;
	return NULL;
    }
    ...
    {
	g_log(BIONET_LOG_DOMAIN, G_LOG_LEVEL_WARNING, 
	      "bionet_value_as_str(): NULL content in string value");
	errno = EINVAL;
	return NULL;	
    }
	...
	g_log(BIONET_LOG_DOMAIN, G_LOG_LEVEL_ERROR, 
	      "bionet_value_as_str(): Out of memory.");
	return NULL;
    }
	...
	{
	    g_log(BIONET_LOG_DOMAIN, G_LOG_LEVEL_WARNING, 
		  "bionet_value_as_string(): value is too big to fit in output string!");
	    free(str);
	    return NULL;
	}
	break;
	...
	{
	    g_log(BIONET_LOG_DOMAIN, G_LOG_LEVEL_ERROR, 
		  "bionet_value_as_string(): Failed to copy string.");
	    free(str);
	    return NULL;
	}
	break;
    ...
    default:
	g_log(BIONET_LOG_DOMAIN, G_LOG_LEVEL_WARNING, 
		  "bionet_value_as_string(): Unknown datatype.");
	free(str);
	return NULL;
    }
